...
def main(in_file, out_file):
    ...
    print("\n{0} processing time {1}".format(in_file, end - start))
...
if __name__ == "__main__":
    files = {
        ...
        "b_lovely_landscapes.txt": "b_lovely_landscapes.out",
        "c_memorable_moments.txt": "c_memorable_moments.out",
        "d_pet_pictures.txt": "d_pet_pictures.out",
        "e_shiny_selfies.txt": "e_shiny_selfies.out"
    }
